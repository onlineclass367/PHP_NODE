...
if($ret->rowCount() == 0){
$sql="update subjects set name=:sfname where id=:eid";
...
<head>
    ...
    <title>Time Table Generator : Course Update</title>
                            ...
                            <div class="card alert">
                                <div class="card-header pr">
                                    ...
                                    <form method="post" name="hjhgh">
                                        <?php
                   $eid=$_GET['editid'];
$sql="SELECT *  from subjects  where id=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
{               ?>
                                         ...
                                         <div class="basic-form m-t-20">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-none input-flat bg-ash" name="sfname" required="true" value="<?php  echo htmlentities($row->name);?>">
                                            </div>
                                        </div>
