...
<head>
    ...
    <title>Time Table Generator Admin : Dashboard</title>
...
?>
                                        <h4 style="color: blue">Total Classes</h4>
                                        <h4 style="color: blue"><?php echo htmlentities($totcourse);?></h4>
                                        <a href="class.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
?>
         ...
         <div class="col-md-6">
                            <div class="card">
                                <div class="media">
                                    <div class="media-left meida media-middle">
                                        <span><i class="ti-file f-s-22 color-danger border-danger round-widget"></i></span>
                                    </div>
                                    <div class="media-body media-text-right">
                                        <?php 
...
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totclassrooms=$query2->rowCount();
?>
                                        <h4 style="color: blue">Total Class Rooms</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($totclassrooms);?></h4>
                                         <a href="class-rooms.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
         ...
         <div class="col-md-6">
                            <div class="card">
                                <div class="media">
                                    <div class="media-left meida media-middle">
                                        <span><i class="ti-file f-s-22 color-info border-info round-widget"></i></span>
                                    </div>
                                    <div class="media-body media-text-right">
                                        <?php 
                        
$sql2 ="SELECT * from  timeslots";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$tottimeslots=$query2->rowCount();
?>
                                        <h4 style="color: blue">Total Time Slots</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($tottimeslots);?></h4>
                                         <a href="time-slots.php"><h5>View Detail</h5></a>
                                    </div>
                                </div>
                            </div>
                        </div>
