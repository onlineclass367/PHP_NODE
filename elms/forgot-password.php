        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"  style="margin-left:320px;"><h4>Employee Password Recovery</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1" style ="border-radius: 30px;">

                                  <div class="card-content ">
                                      <span class="card-title" style="font-size:20px;" align="center">Employee details</span>
