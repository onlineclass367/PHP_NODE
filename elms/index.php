...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>RKB EMPLMS | Home Page</title>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="red darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">RKB EMPLMS | Employee Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright">RKB EMPLMS ©</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12" >
                        <div class="page-title" style="margin-left:127px; color:carbon ;"><h4 >Welcome to Employee Leave Management System</h4></div>

                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1" style ="border-radius: 30px;">

                                  <div class="card-content " >
                                      <span class="card-title" style="font-size:20px;" align="center">Employee Login</span>
